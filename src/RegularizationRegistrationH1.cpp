...
//                    if ((w[0] == 0) && (w[1] == 0) && (w[2] == 0)) regop += beta[1];
        ...
        accfft_execute_c2r_t(this->m_Opt->GetFFT().plan, this->m_v1hat, p_Ainvx1, timer);
        accfft_execute_c2r_t(this->m_Opt->GetFFT().plan, this->m_v2hat, p_Ainvx2, timer);
        accfft_execute_c2r_t(this->m_Opt->GetFFT().plan, this->m_v3hat, p_Ainvx3, timer);
