...
PetscErrorCode PreProcessingRegistration::ResetDDData(int np)
{
    PetscErrorCode ierr;
...
/********************************************************************
 * Name: ApplyMollifier
 * Description: apply mollifier to x
 *******************************************************************/
/*
#undef __FUNCT__
#define __FUNCT__ "ApplyMollifier"
PetscErrorCode PreProcessingRegistration::ApplyMollifier(Vec y, Vec x)
{
    PetscErrorCode ierr;
    PetscFunctionBegin;
...
PetscErrorCode PreProcessingRegistration::SetupDomainComposition(unsigned int n)
{
...
PetscErrorCode PreProcessingRegistration::SetupDomainDecomposition(unsigned int n)
{
...
PetscErrorCode PreProcessingRegistration::DecompositionData(Vec x, unsigned int n, std::string filename)
{
    PetscErrorCode ierr;
    Vec yj;
...
PetscErrorCode PreProcessingRegistration::CompositionData(Vec x, unsigned int n, std::string filename)
{
    PetscErrorCode ierr;
    Vec yj;
    ScalarType *p_yj=NULL,*p_x=NULL;
...
PetscErrorCode PreProcessingRegistration::CompositionTimeDependentData(Vec x, unsigned int n, std::string filename)
{
    PetscErrorCode ierr;
...
PetscErrorCode PreProcessingRegistration::DecompositionTimeDependentData(Vec x, unsigned int n, std::string filename)
{
    PetscErrorCode ierr;
    ScalarType *p_x=NULL, *p_xj=NULL;
    std::string::size_type pos;
