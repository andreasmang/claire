...
SET(COLD_FFTW_CONFIG)
LIST(APPEND COLD_FFTW_CONFIG "")

SET(COLD_FFTW_AVX "")
IF (COLD_USEAVX)
	LIST(APPEND COLD_FFTW_AVX "--enable-avx")
ENDIF(COLD_USEAVX)

MESSAGE( STATUS "COLD_FFTW_DIR: " ${COLD_FFTW_DIR} )
MESSAGE( STATUS "FFTW_CONFIG " ${COLD_FFTW_CONFIG} )

EXTERNALPROJECT_ADD(cold_fftw
	...
	UPDATE_COMMAND ""
	PATCH_COMMAND ""
	CONFIGURE_COMMAND ./configure --prefix=${COLD_FFTW_DIR}/build
								--enable-threads --enable-sse2
								--enable-openmp CFLAGS=-O3
								MAKEINFO=missing ${COLD_FFTW_AVX}
	BUILD_COMMAND make)
...
EXTERNALPROJECT_ADD_STEP(cold_fftw lfftw-config
	DEPENDEES install
	COMMAND cd ${COLD_FFTW_DIR}/src && ./configure --prefix=${COLD_FFTW_DIR}/build
                                --enable-threads --enable-sse2
                                --enable-openmp CFLAGS=-O3
                                MAKEINFO=missing ${COLD_FFTW_AVX} --enable-float)

EXTERNALPROJECT_ADD_STEP(cold_fftw lfftw-build
	DEPENDEES lfftw-config
	COMMAND cd ${COLD_FFTW_DIR}/src && make)

EXTERNALPROJECT_ADD_STEP(cold_fftw lfftw-install
...
EXTERNALPROJECT_ADD(cold_accfft
	DEPENDS cold_fftw
	...
	CMAKE_COMMAND cmake	-DCMAKE_INSTALL_PREFIX=${COLD_ACCFFT_DIR}/build
						-DFFTW_ROOT=${COLD_FFTW_DIR}/build
...
EXTERNALPROJECT_ADD(cold_petsc
...
EXTERNALPROJECT_ADD(cold_niftlib
