...
defpara='-pdesolver sl -regnorm h1s -precond 2level -pcsolver fpcg -pcsolvermaxit 10 -opttol 1.000000e-01 -nt 4 -xresult -usenc -logworkload -verbosity 2 -ric -betaw 1.000000e-04'
