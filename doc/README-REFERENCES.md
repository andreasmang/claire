...
* A. Mang & G. Biros, A semi-Lagrangian two-level preconditioned Newton-Krylov solver for constrained diffeomorphic image registration, SIAM Jornal on Scientific Computing (2017) [[arxiv](https://arxiv.org/abs/1604.02153)].
