...
class RegularizationH3SN : public Regularization {
 public:
    typedef Regularization SuperClass;
    typedef RegularizationH3SN Self;

    RegularizationH3SN(void);
    RegularizationH3SN(RegOpt*);
    virtual ~RegularizationH3SN(void);
