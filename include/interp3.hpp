...
void interp3_ghost_xyz_p( Real* reg_grid_vals, int data_dof,
              int* N_reg, int * N_reg_g,int* isize_g, int* istart, const int N_pts,int g_size, Real* query_points,
...
void par_interp3_ghost_xyz_p( Real* reg_grid_vals, int data_dof,
...
void par_interp3_ghost_xyz_p( Real* reg_grid_vals, int data_dof,
              int* N_reg, int * isize, int* istart, const int N_pts,int g_size, Real* query_points,
              Real* query_values,int* c_dims,MPI_Comm c_comm,Interp3_Plan* interp_plan);
